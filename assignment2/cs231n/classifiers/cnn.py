...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        cache = {}
        out1, cache[1] = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        out2, cache[2] = affine_relu_forward(out1, W2, b2)
        scores, cache[3] = affine_forward(out2, W3, b3)
        ...
        dx3, dw3, db3 = affine_backward(dx4, cache[3])
